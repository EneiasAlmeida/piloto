...
<body class="bg-neutral-900 min-h-screen flex flex-col items-center justify-center px-4">
    ...
    <div class="flex items-center justify-center w-full">
        <form method="POST" action="{{ route('login.store') }}"
            ...
            <button class="bg-neutral-700 rounded py-3 text-white hover:bg-green-800 transition duration-500 w-full">
                <a href="{{ route('login.create') }}"
                    class="bg-neutral-700 rounded py-3 text-white hover:bg-green-800 transition duration-500 w-full text-center">
                    Cadastrar-se
                </a>
            </button>
        </form>
