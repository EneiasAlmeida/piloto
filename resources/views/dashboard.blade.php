    ...
    <menu class="bg-neutral-700 h-20 flex items-center justify-between px-6 space-x-4">
        ...
        <div class="flex justify-end space-x-4">
            <a href="{{ route('dashboard') }}"
                class="bg-neutral-700 text-white px-2 py-2 rounded hover:bg-red-600">Dashboard</a>
            <a href="{{ route('event.create') }}"
                class="bg-neutral-700 text-white px-4 py-2 rounded hover:bg-red-600">Cadastrar Eventos</a>
            <a href="{{ route('event.list') }}"
                class="bg-neutral-700 text-white px-4 py-2 rounded hover:bg-red-600">Eventos</a>
    ...
    <section class="flex justify-center mt-10 px-4">
        <div class="bg-neutral-800 text-white rounded-lg shadow-lg w-full max-w-6xl p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
                <div
                    class="bg-neutral-700 p-6 rounded text-center text-red-500  font-bold  h-40  border-4 border-black flex items-center justify-center ">
                ...
                <div
                    class="bg-neutral-700 p-6 rounded text-center text-red-500  font-bold  h-40  border-4 border-black flex items-center justify-center ">
                    Eventos à Confirmar</div>
                <div
                    class="bg-neutral-700 p-6 rounded text-center text-red-500  font-bold  h-40  border-4 border-black flex items-center justify-center ">
                    Total de Eventos</div>
                <div
                    class="bg-neutral-700 p-6 rounded text-center text-red-500  font-bold  h-40  border-4 border-black flex items-center justify-center ">
                    Datas Disponiveis</div>
                <div
                    class="bg-neutral-700 p-6 rounded text-center text-red-500  font-bold  h-40  border-4 border-black flex items-center justify-center ">
                    Anotações</div>
